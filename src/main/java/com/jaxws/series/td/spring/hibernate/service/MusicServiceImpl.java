...
import com.jaxws.series.td.spring.hibernate.dao.MusicDAOImpl;
...
public class MusicServiceImpl extends SpringBeanAutowiringSupport implements IMusicService {
	...
	public MusicDAOImpl getMusicDAOImpl() {
		return musicDAOImpl;
	}



	public void setMusicDAOImpl(MusicDAOImpl musicDAOImpl) {
		this.musicDAOImpl = musicDAOImpl;
	}
    ...
    public MusicListResponseType getAllMovieDetailByComposer(MusicListRequestType parameters) throws BusinessException {
        ...
        try{
            if(null != parameters && !parameters.getComposerName().equalsIgnoreCase("")){
                ...
                lstMusic = getMusicDAOImpl().getAllMoviesByComposer(parameters.getComposerName());
